#!/usr/bin/env python3
"""
Test script to verify Discord embed creation with the user-provided link
"""
...
async def main():
    ...
    test_data = {
        'message': "Test message from user content",
    ...
    # Send a test message
    logger.info("Sending test message with embed")
